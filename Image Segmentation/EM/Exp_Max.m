...
% for i=1:num_of_means
%     num(i)=randi(size(Feature_vector,1));
...
[image,mean_table,clusters,percent,temp]=kmeans2(new_mean,Feature_vector,color_vals,num_of_means,i,ImgMap);
% fig(i),imshow(image);
