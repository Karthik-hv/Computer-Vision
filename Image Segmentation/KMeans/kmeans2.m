...
% end
function [k_meansint,updated_mean,Clusters,Per,temp]=kmeans2(mean,Normalized_FV,color_vals,num_of_means,iter,ImgMap,vid);
...
Per=accuracy(ImgMap,k_meansint,iter);
